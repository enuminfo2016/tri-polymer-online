...
public class RequestPath {
	...
	public static final String SECURED_REST_ENDPOINT = "/api/secured/v1";
	public static final String SECURITY_REST_ENDPOINT = "/api/security";
	public static final String UNSECURED_REST_ENDPOINT = "/api/v1";
