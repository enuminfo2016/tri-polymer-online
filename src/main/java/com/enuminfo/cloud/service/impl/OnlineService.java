...
public class OnlineService implements IOnlineService {
	...
	public List<String> getAllStates(String country) {
		List<String> values = new ArrayList<>();
		Optional<Country> optional = Optional.ofNullable(countryRepository.findByName(country));
	...
	public List<CatalogProductDto> getProductsByCategory(String value) {
		...
		Optional<Catalog> optionalCatalog = Optional.ofNullable(catalogRepository.findByStartDateAndEndDate(dates.get(0), dates.get(1)));
