...
public class LaunchTriPolymerOnlineApplication {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("TriPolymer Online API", "ENUMInfo | TriPolymer Online API Framework", "0.0.1-SNAPSHOT",
				"Terms of service", new Contact("ENUMInfo Team", "www.enuminfo.com", "enuminfo2016@gmail.com"),
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.enuminfo.cloud")).paths(PathSelectors.ant("/api/*"))
	...
	public DataSourceInitializer dataSourceInitializer(@Qualifier("dataSource") final DataSource dataSource)
		...
		if (activeEnv.name().equalsIgnoreCase(EnvironmentEnum.DEV.name())) {
